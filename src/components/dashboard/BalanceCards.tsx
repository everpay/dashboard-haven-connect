      ...
      <div className="grid grid-cols-6 gap-2 mb-6">
        ...
        <Card className="p-3 border-purple-200 bg-purple-50 dark:bg-purple-950 dark:border-purple-900">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-purple-600 dark:text-purple-400 text-balance break-words">3</p>
          </div>
        </Card>
        ...
        <Card className="p-3 border-gray-200 bg-gray-50 dark:bg-gray-950 dark:border-gray-800">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-gray-600 dark:text-gray-400 text-balance break-words">0</p>
          </div>
        </Card>
      </div>
    </>
