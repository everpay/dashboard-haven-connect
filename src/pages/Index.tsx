    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid gap-6 grid-cols-12">
          {/* Balance Card */}
          <Card className="col-span-5 p-6 bg-white rounded-2xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-medium">Total balance</h3>
                <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">+2%</span>
              </div>
          ...
          {/* Scheduled Transfers */}
          <Card className="col-span-7 p-6 bg-white rounded-2xl">
            <div className="flex items-center justify-between mb-6">
          ...
          {/* Chart */}
          <Card className="col-span-12 p-6 bg-white rounded-2xl">
            <div className="flex items-center justify-between mb-6">
